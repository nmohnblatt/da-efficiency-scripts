...
scheme = makeFRIUDRScheme(datasize, invrate=2)
table.append(makeRow("FRI (UDR, 1/2)", scheme, tex))

scheme = makeFRIJohnsonScheme(datasize, invrate=2)
table.append(makeRow("FRI (Johnson, 1/2)", scheme, tex))
...
scheme = makeFRIUDRScheme(datasize, invrate=32)
table.append(makeRow("FRI (UDR, 1/32)", scheme, tex))

scheme = makeFRIJohnsonScheme(datasize, invrate=32)
table.append(makeRow("FRI (Johnson, 1/32)", scheme, tex))
